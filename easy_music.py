...
if __name__ == "__main__":
    ...
    track_name = tk.Label(track_details_frame,text="Song title...",padx=20,font=15)
    ...
    playlist = tk.Listbox(right_frame,selectmode=tk.SINGLE,activestyle=tk.NONE,font=13,cursor="hand2",width=22,yscrollcommand=playlist_scrollbar.set)
    ...
    volume_slider = tk.Scale(right_frame,from_=0,to=10,orient=tk.HORIZONTAL,cursor="hand2",font=13,length=110,command=on_volume_changed)
